...
EMD_matrix=genfromtxt('../preprocessing/T2T_WMD_matrices/hangupit2_T2T_WMD_matrix.txt', skip_header=0) #load EMD matrix for sentences
...
MAX_TFIDF_matrix = genfromtxt('../preprocessing/MAX_tfidf_SCORE/hangupit2_max_tfidf_score.txt', skip_header=0) #load EMD matrix for sentences
...
MAX_TWEET_length_matrix=genfromtxt('../preprocessing/MAX_TWEET_LENGTH/hangupit2_max_tweet_length.txt', skip_header=0) #load EMD matrix for sentences
...
clean_text_data=[]
filepath = '../preprocessing/clean_tweets/hangupit/clean2_hangupit_replace@amp.csv'
...
"""----------------------------Fetch actual Tweets ----------------------------------------- """
actual_text_data=[]
filepath1 = '../data_set/ensemble-summarization-intellisys-2018-dataset/input_datasets/hagupit_input_data.txt'
...
filepath2 = '../data_set/ensemble-summarization-intellisys-2018-dataset/gold-standard-summaries/annotator1/annotator1-hagupit-summary.txt'
...
actual_summary2=''
filepath3 = '../data_set/ensemble-summarization-intellisys-2018-dataset/gold-standard-summaries/annotator2/annotator2-hagupit-summary.txt'
...
actual_summary3=''
filepath4 = '../data_set/ensemble-summarization-intellisys-2018-dataset/gold-standard-summaries/annotator3/annotator3-hagupit-summary.txt'
